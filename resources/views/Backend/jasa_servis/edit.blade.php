            ...
            <div class="container-fluid">
                <div class="card shadow-lg border-0">
                    <div style="background-color: #111c43; color: white;"
                        ...
                        <h3 class="mb-0"><i class="fas fa-tools"></i> Edit Jasa Servis</h3>
                        <div class="ml-auto">
                    ...
                    <div class="card-body">
                        <form action="{{ route('jasa_servis.update', $jasaServis->id) }}" method="POST">
                            @csrf
                            @method('PUT')
